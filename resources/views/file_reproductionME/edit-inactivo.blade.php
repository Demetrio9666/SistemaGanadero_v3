...
<form action=" {{route('inactivos.fichaReproduccionEx.update',$ext->id)}}" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="animalCode_Exte" name="animalCode_Exte" value="{{$ext->animalCode_Exte}}" onblur="upperCase()" disabled=disabled>
        </div>
        ...
        <div class="col-md-6">
            ...
            <select class="form-control" id="sex"  name="sex" value="{{$ext->sex}}" disabled=disabled>
        ...
        <center>
            <div class="form-group" style="margin: 40px">
                <a type="submit" class="btn btn-secondary btn" href="{{url('/inactivos/fichaReproduccionEx')}}">Cancelar</a>
                <button type="submit" class="btn btn-success btn"  href="{{ Redirect::to('/inactivos/fichaReproduccionEx') }}" >Guardar</button>
            </div>
        </center>
