<body>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body" style="width:100%">
                <?php echo $__env->make('tablas.tablaAnimalesHembra', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
  ...
  </body><?php /**PATH C:\xampp\htdocs\SistemaGanadero\resources\views/modal/modalAnimalesHembras.blade.php ENDPATH**/ ?>